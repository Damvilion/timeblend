...
export default function About({ id }: InferGetServerSidePropsType<typeof getServerSideProps>) {
    ...
    return (
        <Flex direction='column'>
            ...
            <Flex justify='center' direction='row' w='100%' h='600px' px={[2, 4, 5, 5]} bg='white' >
                <Flex direction='column' w={['100%', '100%', '70%', '70%']} minW='200px' maxW='920px' h='100%' px={[0, 1, 2, 4]} py={4} borderRight='1px dashed #dcdee0' borderLeft='1px dashed #dcdee0'>
