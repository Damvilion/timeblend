                    ...
                    <Flex>
                        <Flex direction='column'>
                            ...
                            <Flex maxW='240px' mt={1} ml={3} fontSize='13.5px'>
                                ...
                                <Text ml='19.5px' color='#818181'>
                                    3
                                </Text>
                                <Text ml='22.5px' color='#818181'>
                                    6
                                </Text>
                                <Text ml='22.5px' color='#818181'>
                                    9
                                ...
                                <Text ml='20px' color='#818181'>
                                    3
                                </Text>
                                <Text ml='21.5px' color='#818181'>
                                    6
                                </Text>
                                <Text ml='21.5px' color='#818181'>
                                    9
                        ...
                        <Flex direction='column' w='240px' maxW='240px'>
                            ...
                            <Menu>
                                <MenuButton h='40px' mt={2.5} ml={2} pr='14px' pl='14px' color='#00142C' bg='#F7F7F7' border='2px solid lightgray' borderRadius={4} aria-label='Options'>
                                    <HStack w='100%'>
