                ...
                <Flex direction='column' w='100%' minW='200px' maxW='800px' h='100%' px={[0, 1, 2, 4]} py={4} borderRight='1px dashed #dcdee0' borderLeft='1px dashed #dcdee0'>
                    <Flex align={['center', 'center', 'start', 'start']} direction={['column', 'column', 'row', 'row']} w='100%'>
                        <Flex direction='column' w={['100%', '100%', '100%', '50%']}>
                            ...
                            <RangeSlider maxW='340px' mt={3} ml={[2.5,10,2.5,2.5]} aria-label={['min', 'max']} defaultValue={[9, 17]} max={24} min={0} minStepsBetweenThumbs={1} onChange={(val) => setSliderValue(val)} step={1}>
                        ...
                        <Flex direction='column' w={['100%', '100%', '100%', '50%']} mt={['34px', '34px', '0', '0']}>
                            ...
                            <Menu>
                                <MenuButton w='330px' h='40px' mt='15px' ml={[2,10,2,2]} pr='14px' pl='14px' color='#00142C' bg='#F7F7F7' border='2px solid lightgray' borderRadius={4} aria-label='Options'>
                                    <HStack w='100%'>
                                        <Text mr='auto'>{getEventTypeString(eventType)}</Text>
                                        <FiChevronDown />
                                    </HStack>
                                </MenuButton>
                                <MenuList w='330px' py={0} color='#00142C' bg='#F7F7F7' border='2px solid #d3d3d3' borderRadius={4} shadow='xl' motionProps={{
                            ...
                            <Text ml={[2,10,2,2]} color='#717171' fontSize='11.5pt'>Click and drag to select date ranges.</Text>
                        </Flex>
                    ...
                    <Flex align='center' justify='center' flexShrink='0' maxW='190px' h='52px' mt={10} mr={1} mb={10} ml={[2,10,2,2]} px={3} bg='#E6E7F9' borderRadius={5} shadow='0 7px 14px rgba(50, 50, 93, 0.08), 0 3px 2px rgba(0, 0, 0, 0.06);' _hover={{transform: 'translateY(-1px)', bg: '#ebecfc', cursor: 'pointer', boxShadow: '0 7px 14px rgba(50, 50, 93, 0.08), 0 3px 2px rgba(0, 0, 0, 0.06);'}}>
